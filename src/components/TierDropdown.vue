<template>
  <div ref="dropdownRef" class="relative">
    ...
    <div
      v-if="open"
      class="absolute left-0 z-10 mt-1 w-full rounded-lg border border-gray-500/10 bg-white py-1 shadow-lg md:right-0 dark:border-nalika-border dark:bg-nalika-surface"
    >
      <button
